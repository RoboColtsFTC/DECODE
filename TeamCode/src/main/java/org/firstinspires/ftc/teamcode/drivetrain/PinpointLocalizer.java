...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -8.44460105135f;  //-168/19.89436789 mm y position of the parallel encoder (in tick units)
        public double perpXTicks = -4.423362455f; // x -88/19.89436789 mm position of the perpendicular encoder (in tick units)
    }
